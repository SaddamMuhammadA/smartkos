...
return new class extends Migration {
    public function up(): void
    {
        ...
        // Table: jenis_kamar
        if (!Schema::hasTable('jenis_kamar')) {
        ...
        // Table: jadwal_kamar
        if (!Schema::hasTable('jadwal_kamar')) {
        ...
        if (!Schema::hasTable('jadwal_kamar_kendaraan')) {
        ...
        // Table: transaksi_log
        if (!Schema::hasTable('transaksi_log')) {
        ...
        // Table: promo_kamar
        if (!Schema::hasTable('promo_kamar')) {
        ...
        // Table: admin_invites
        if (!Schema::hasTable('admin_invites')) {
